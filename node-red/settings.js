...
module.exports = {
    ...
    // To enabled pretty-printing of the flow the flow file, set the following
    //  property to true:
    //flowFilePretty: true,
    ...
    adminAuth: {
        ...
        users: [{
            username: "guilhem",
            password: process.env.NODE_RED_GUILHEM_PASSWORD,
            permissions: "*"
        },
        {
            username: "fred",
            password: process.env.NODE_RED_FRED_PASSWORD,
            permissions: "*"
        }]
    },
